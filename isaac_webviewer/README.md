...
`http://<simulator-host>:8210/`, or the `http_port` a launcher prefers for it; a viewer whose port is already held takes one of its own and logs the address it took. It serves the frontend from the base image's

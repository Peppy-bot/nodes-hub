...
class Pose:
    ...
    def __post_init__(self) -> None:
        # Owned copies, frozen in depth: a frozen dataclass over writable
        # views would still let a caller mutate the pose underneath.
        ...
        orientation = quat_canonical(quat_normalize(self.orientation))

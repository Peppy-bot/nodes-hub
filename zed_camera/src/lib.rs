...
//! factory geometry, [`resolution`] names the capture modes, [`capture`]
//! streams frames and drives controls through the `v4l` crate, and
//! [`cv_depth`] rectifies and matches through the maintained opencv crate.

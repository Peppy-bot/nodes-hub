...
def test_node_stages_the_head_camera_pack_where_launch_reads_it():
    ...
    assert (_NODE_DIR / "robots" / "openarm" / "head_camera.py").is_file()
    launch = (_NODE_DIR / "robots" / "openarm" / "openarm" / "launch.py").read_text()
    ...
    assert "openarm/sim_isaac/robots/openarm/openarm/assets/head_camera/" in ignored

...
def test_the_default_chest_pose_looks_ahead_and_down():
    ...
    chest = CameraModel.from_parameters(52.0, "0.065 0.0315 0.8218 0.1710647 -0.1710647 -0.6861027 0.6861027")
    ...
    assert close(point, (0.065 + forward[0], 0.0315, 0.8218 + forward[2]), 1e-3)

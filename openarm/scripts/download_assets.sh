...
rm -rf "/tmp/.peppy_openarm_assets_${VARIANT}"
mkdir -p "/tmp/.peppy_openarm_assets_${VARIANT}"
_rclone copy "r2:${BUCKET}/openarm01/${VARIANT}/assets/" "/tmp/.peppy_openarm_assets_${VARIANT}/" --progress

...
The `openarm_simulation` launcher deploys one copy, `alpha`, a v2 with the
web commander, and the simulation is selected at launch; `fleet` deploys
none and every robot joins it. These are separate sessions:

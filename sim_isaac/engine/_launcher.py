#!/usr/bin/env python3
"""Isaac Sim SimLauncher for the simulation node: the thread that steps the
stage."""
...
class SimLauncher:
    ...
    def run(self) -> None:
        ...
        try:
            ...
            # The rig of its model is rendered for each robot that pairs a
            # camera, and the settings below are what a capture needs from
            # the renderer.

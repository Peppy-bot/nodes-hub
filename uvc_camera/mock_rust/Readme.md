...
This is the Rust mock node (`uvc_camera_rust_mock`); it conforms to the `uvc_camera` contract and emulates a real camera with fake input parameters. Start it with:
```
